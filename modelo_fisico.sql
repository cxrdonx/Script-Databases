...
insert into empleados values(101,1,1,222,444,020,0201,'Claudia lucia cuellar ',2347891234101, 'clcuellar@gmail.com', '5av 3-33 zona 11', 23541530, 38405060)
insert into empleados values(101,1,1,222,444,020,0201,'Fernando alvizures',2347891234101, 'clcuellar@gmail.com', '5av 3-33 zona 11', 23541530, 38405060)
...
alter table historial_sueldo add(
...
update depto_trabajo set descripcion = 'contador' where descripcion ='financiero'; 


select empleados.codigo_empleado, depto_trabajo.descripcion
from empleados
inner join depto_trabajo on empleados.departamentos = depto_trabajo.codigo_dpto_trabajo;

update depto_trabajo
set descripcion = 'Economista'
where codigo_depto_trabajo =2;

delete into municipios where codigo_municipio = 0513;